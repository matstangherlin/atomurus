...
(function () {
  ...
  var routes = [
    ...
    { href: 'viewer/atomic-models.html',       label: 'Viewer',        i18n: 'common.nav.visualizador' },
    ...
    { href: '/app',                            label: 'Workspace',     i18n: 'common.nav.workspace' },
    { sep: true },
    { href: 'login.html',                      label: 'Account',       i18n: 'common.nav.login' },
    { href: 'config.html',                     label: 'Settings',      i18n: 'common.nav.settings' },
