(function () {
  ...
  var FB = {
    en: {
      ...
      labEquilibrium: 'Equilibrium Workbench',
      labEquilibriumLede: 'Calculate Kc and Kp. Compare Q with K. Solve equilibrium concentrations with ICE tables.',
      labAcidBase: 'Acid–Base Workbench',
      labAcidBaseLede: 'Solve weak acids, weak bases and buffer systems.',
      solveEquilibrium: 'Solve equilibrium',
      solveAcidBase: 'Solve acid–base',
      equilibriumConstant: 'Kc / Kp',
      equilibriumConstantK: 'K',
      reactionQuotient: 'Reaction quotient Q',
      iceTable: 'ICE table',
      iceInitial: 'Initial',
      iceChange: 'Change',
      iceEquilibrium: 'Equilibrium',
      speciesFormula: 'Species',
      partialPressure: 'Partial pressure',
      equilibriumValues: 'Equilibrium values',
      ...
      weakAcid: 'Weak acid',
      weakBase: 'Weak base',
      bufferSolution: 'Buffer',
      acidBaseConstants: 'Ka / Kb',
      kwNote: 'Acid–base calculations in V1 use Kw = 1.0 × 10⁻¹⁴ at 25 °C.',
      analyticalConcentration: 'Analytical concentration',
      percentIonization: 'Percent ionization',
      acidBuffer: 'Acid buffer',
      baseBuffer: 'Base buffer',
      concentrations: 'Concentrations',
      molesAndVolume: 'Moles and volume',
      acidSpecies: 'HA',
      baseSpecies: 'A−',
      bufferType: 'Buffer type',
      inputMode: 'Input mode',
      acidAmount: 'Acid amount',
      baseAmount: 'Base amount',
      conjugatePair: 'Conjugate Ka × Kb = Kw',
    ...
    pt: {
      ...
      labEquilibrium: 'Laboratório de Equilíbrio',
      labEquilibriumLede: 'Calcule Kc e Kp. Compare Q com K. Resolva concentrações no equilíbrio com tabelas ICE.',
      labAcidBase: 'Laboratório Ácido–Base',
      labAcidBaseLede: 'Resolva ácidos fracos, bases fracas e soluções tampão.',
      solveEquilibrium: 'Resolver equilíbrio',
      solveAcidBase: 'Resolver ácido–base',
      equilibriumConstant: 'Kc / Kp',
      equilibriumConstantK: 'K',
      reactionQuotient: 'Quociente de reação Q',
      iceTable: 'Tabela ICE',
      iceInitial: 'Inicial',
      iceChange: 'Variação',
      iceEquilibrium: 'Equilíbrio',
      speciesFormula: 'Espécie',
      partialPressure: 'Pressão parcial',
      equilibriumValues: 'Valores no equilíbrio',
      currentComposition: 'Composição atual',
      initialConcentration: 'Concentração inicial',
      addSpeciesRow: 'Adicionar espécie',
      copyExpression: 'Copiar expressão',
      modelAssumptions: 'Hipóteses do modelo',
      purePhase: 'puro',
      weakAcid: 'Ácido fraco',
      weakBase: 'Base fraca',
      bufferSolution: 'Solução tampão',
      acidBaseConstants: 'Ka / Kb',
      kwNote: 'Os cálculos ácido–base da V1 usam Kw = 1,0 × 10⁻¹⁴ a 25 °C.',
      analyticalConcentration: 'Concentração analítica',
      percentIonization: 'Percentual de ionização',
      acidBuffer: 'Tampão ácido',
      baseBuffer: 'Tampão básico',
      concentrations: 'Concentrações',
      molesAndVolume: 'Mols e volume',
      acidSpecies: 'HA',
      baseSpecies: 'A−',
      bufferType: 'Tipo de tampão',
      inputMode: 'Modo de entrada',
      acidAmount: 'Quantidade de ácido',
      baseAmount: 'Quantidade de base',
      conjugatePair: 'Par conjugado Ka × Kb = Kw',
