...
assert.equal(paid.features.weakBaseSolver, true);
...
assert.equal(expiredStudy.features.equilibriumWorkbench, false);
assert.equal(expiredStudy.features.acidBaseWorkbench, false);
...
assert.equal(trialStudy.features.equilibriumWorkbench, true);
assert.equal(trialStudy.features.acidBaseWorkbench, true);
