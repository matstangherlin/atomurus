...
function writeChunk(ns, chunk) {
  const outPath = path.join(OUT_DIR, `${ns}.js`);
  const output =
    '// Auto-generated by tools/build-i18n-assets.js\n' +
    'window.__ATOMURUS_I18N_CHUNKS__ = window.__ATOMURUS_I18N_CHUNKS__ || {};\n' +
    `window.__ATOMURUS_I18N_CHUNKS__[${JSON.stringify(ns)}] = ${JSON.stringify(chunk)};\n`;
