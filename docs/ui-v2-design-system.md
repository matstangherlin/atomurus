...
Chrome (Prompt 03) lives in [`docs/ui-v2-chrome.md`](ui-v2-chrome.md). Auth (Prompt 04) lives in [`docs/ui-v2-auth.md`](ui-v2-auth.md). Home and `/app` still do not load this bundle.
