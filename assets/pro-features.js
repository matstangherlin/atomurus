...
(function (root) {
  ...
  var FEATURES = [
    { id: 'studyLibrary', category: 'study', access: 'account', status: 'live', route: '/app?section=study', titleEn: 'Study Library', titlePt: 'Biblioteca', shortEn: 'Save elements, molecules and articles.', shortPt: 'Salve elementos, moléculas e artigos.' },
    ...
    { id: 'studyProgress', category: 'study', access: 'account', status: 'live', route: '/app?section=work', titleEn: 'Progress', titlePt: 'Progresso', shortEn: 'Pick up where you left off.', shortPt: 'Retome de onde parou.' },
    { id: 'reactionWorkbench', category: 'solve', access: 'pro', status: 'live', route: '/app?section=lab&panel=analysis&tool=reactions', titleEn: 'Reaction Workbench', titlePt: 'Laboratório de Reações', shortEn: 'Balance equations and continue into stoichiometry.', shortPt: 'Balanceie equações e siga para a estequiometria.' },
    { id: 'formulaSolver', category: 'solve', access: 'pro', status: 'live', route: '/app?section=lab&panel=analysis&tool=formula', titleEn: 'Formula Solver', titlePt: 'Formula Solver', shortEn: 'Work with empirical and molecular formulas.', shortPt: 'Trabalhe fórmulas empíricas e moleculares.' },
    { id: 'solutionBuilder', category: 'solve', access: 'pro', status: 'live', route: '/app?section=lab&panel=analysis&tool=solutions', titleEn: 'Solution Builder', titlePt: 'Preparação de Soluções', shortEn: 'Prepare and compare solution calculations.', shortPt: 'Prepare e compare cálculos de soluções.' },
    { id: 'advancedCalculations', category: 'solve', access: 'pro', status: 'live', route: '/app?section=lab&panel=analysis&tool=calculations', titleEn: 'Advanced Calculations', titlePt: 'Cálculos avançados', shortEn: 'Compare multiple scenarios.', shortPt: 'Compare vários cenários.' },
    { id: 'elementCompare', category: 'analyze', access: 'pro', status: 'live', route: '/app?section=lab&panel=analysis&tool=elements', titleEn: 'Element Compare', titlePt: 'Comparar elementos', shortEn: 'Compare periodic properties side by side.', shortPt: 'Compare propriedades periódicas lado a lado.' },
    { id: 'moleculeCompare', category: 'analyze', access: 'pro', status: 'live', route: '/app?section=lab&panel=analysis&tool=molecules', titleEn: 'Molecule Compare', titlePt: 'Comparar moléculas', shortEn: 'Compare molecular composition.', shortPt: 'Compare a composição molecular.' },
    { id: 'atomicCompare', category: 'analyze', access: 'pro', status: 'live', route: '/app?section=lab&panel=analysis&tool=atomic', titleEn: 'Atomic Compare', titlePt: 'Comparar átomos', shortEn: 'Compare electronic structure.', shortPt: 'Compare a estrutura eletrônica.' },
    { id: 'labSessions', category: 'analyze', access: 'pro', status: 'live', route: '/app?section=lab&panel=analysis&tool=sessions', titleEn: 'Saved Lab Sessions', titlePt: 'Sessões salvas', shortEn: 'Reopen analyses in Pro Lab.', shortPt: 'Reabra análises no Pro Lab.' },
