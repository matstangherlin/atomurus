...
(function (root) {
  ...
  var FEATURES = [
    ...
    { id: 'studyInsights', category: 'study', access: 'pro', status: 'live', route: '/app?section=insights', titleEn: 'Insights', titlePt: 'Insights', shortEn: 'See how your study is progressing.', shortPt: 'Veja como o estudo está avançando.' },
