(function(){
  ...
  var css=''
    ...
    +'#aco-cookie-banner .aco-title{font-family:"Instrument Serif",Georgia,serif;font-size:20px;font-weight:400;color:var(--lc-ink,var(--text-1,#14120E));letter-spacing:-.02em}'
    ...
    +'#aco-cookie-banner button{flex:1;font-family:inherit;font-size:13px;font-weight:600;padding:9px 14px;min-height:40px;border-radius:10px;border:1px solid var(--lc-rule,var(--border,#D8D2BF));background:transparent;color:var(--lc-ink-2,var(--text-2,#58544A));cursor:pointer;transition:all .15s}'
