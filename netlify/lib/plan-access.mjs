...
export function accessForUser(user) {
  ...
  return {
    ...
    features: {
      ...
      equilibriumWorkbench: isPro,
      equilibriumSolver: isPro,
      reactionQuotient: isPro,
      iceTableSolver: isPro,
      acidBaseWorkbench: isPro,
      weakAcidSolver: isPro,
      weakBaseSolver: isPro,
      bufferSolver: isPro,
      acidBaseConstants: isPro,
